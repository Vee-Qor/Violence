...
void AVQueenOfPain::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void AVQueenOfPain::PawnClientRestart()
{
    Super::PawnClientRestart();

    checkf(InputConfig, TEXT("Forgot to assign InputConfig in %s"), *GetName())
    ensureAlwaysMsgf(InputConfig->DefaultInputMappingContext, TEXT("Input Mapping Context is empty in %s"), *InputConfig->GetName());
    ...
    InputSubsystem->RemoveMappingContext(InputConfig->DefaultInputMappingContext);
    InputSubsystem->AddMappingContext(InputConfig->DefaultInputMappingContext, 0);
}

void AVQueenOfPain::HandleMoveInput(const FInputActionValue& InputActionValue)
{
...
void AVQueenOfPain::HandleLookInput(const FInputActionValue& InputActionValue)
{
